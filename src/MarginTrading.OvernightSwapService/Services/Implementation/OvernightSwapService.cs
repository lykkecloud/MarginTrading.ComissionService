...
using MarginTrading.OvernightSwapService.Models.Extensions;
...
namespace MarginTrading.OvernightSwapService.Services.Implementation
{
	...
	public class OvernightSwapService : IOvernightSwapService
	{
		...
		private readonly IReloadingManager<MarginTradingOvernightSwapServiceSettings> _marginSettings;
		...
		public OvernightSwapService(
			...
			IReloadingManager<MarginTradingOvernightSwapServiceSettings> marginSettings,
			ILog log)
		{
		...
		private DateTime CalcLastInvocationTime()
		{
			...
			var settingsCalcTime = (_marginSettings.CurrentValue.OvernightSwapCalculationTime.Hours,
